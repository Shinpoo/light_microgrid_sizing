...
class Data:
    ...
    def plotRepresentativeTimeseries(self, label, representativeDays, resolution=0.01, pathPrefix=""):
        ...
        # if label.name == "Conso":
        #     LD_load = {"X": x, "reprX": reprX, "Y": y}
        #
        #     path = "results/LDAA.json"
        #     with open(path, 'w') as file:
        #         json.dump(LD_load, file, indent=4, separators=(',', ': '))
        ...
        pyplot.savefig(pathPrefix +"/LD_" + label.name + ".pdf")
